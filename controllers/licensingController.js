...
// @desc    קבלת כל פריטי הרישוי
// @route   GET /api/licensing-items
// @access  Public (או מורשה בלבד, תלוי בדרישה)
